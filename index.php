...
<html lang="en">
  ...
  <body id="page-top">
    ...
    <!-- About Section -->
    <section id="about" class="team-section content-section text-center">
      <div class="container">
        <div class="row">
          <div class="col-lg-8 mx-auto">
            <h2>About</h2>
			<img class="img-fluid" src="img/LogoJankric1x05.png" alt="Logo" style="width: 35%;">
			<br><br>
            <p>Jankric Respawn is an Indie Game Developer from Depok, Jawa Barat. Indonesia.</p>
            <p>Formed by a group of teens whom bet their time learning to make great games.</p>
          </div>
        </div>
      </div>
    </section>
    ...
    <!-- Our Team Section -->
    <!--section id="our-team" class="team-section content-section text-center">
      <div class="container">
        <div class="col-lg-8 mx-auto">
          <h2>Our Team</h2>
    ...
    <section id="contact" class="content-section text-center">
      <div class="container">
        <div class="row">
          <div class="col-lg-8 mx-auto">
            <h2>Contact</h2>
            <p>Thank you for visited this website. Feel free to comment and follow us on:</p>
